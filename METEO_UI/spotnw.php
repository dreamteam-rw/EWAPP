                ...
                <div class="post">
                  <div class="user-block">
                    <img class="img-responsive img-bordered-sm" src="dist/img/al.png" alt="user image">
                        <span class="username">
                          <a href="#"> Disaster Alert 000<?php  echo $alert['alert_id'] ?> :   <small><?php  echo $District;  ?></small> </a>
                         </span>
               ...
               ?> 
                       ...
                       <?php if(!empty($users)): $count = 0; foreach($users as $us): $count++; 
                        ...
                        <li class="right clearfix"><span class="chat-img pull-right">
                            <img src="http://placehold.it/50/FA6F57/fff&text=MT" alt="User Avatar" class="img-circle" />
                        </span>
                        ...
                        <li class="left clearfix"><span class="chat-img pull-left">
                            <img src="http://placehold.it/50/55C1E7/fff&text=MD" alt="User Avatar" class="img-circle" />
                        </span>
                            <div class="chat-body clearfix">
                                <div class="header">
...
<?php endif;  $ct=0;?>
                ...
                <div class="panel-footer">
                  <form  action="class/config.php?al=<?php  echo $alert['alert_id'] ?>&us=1" method="post">
