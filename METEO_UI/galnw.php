                    ...
                    <div class="box-body" style="padding: 30px;">
                         ...
                         <div class="form-group">
                          ...
                          <label>Phone Number </label>
                           <input name="user_phone" class="form-control" placeholder="Phone Number">
                          <br>
...
<label>Email</label>
                    ...
                    <div class="box-footer clearfix">
                        <a href="gal-list" class="btn btn-sm btn-default btn-flat pull-left">Cancel </a>
                        <button type="submit" name="galNews" class="btn btn-sm btn-info btn-flat pull-right"> Save  </button>
                    </div>
                    <!-- /.box-footer -->
                  </div>
                 <!--RECENT REGISTER -->
