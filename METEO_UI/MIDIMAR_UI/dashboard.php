...
$Dte = date('Y/m/d');
                   $condition =array 
                (
                  'where'=>array('date' => $Dte ,),

                );

              $forecasts = $db->getRows('forecast',$condition);

               ?>

 <?php if(!empty($forecasts)): $count = 0; foreach($forecasts as $forecast): $count++; ?>
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">Max: <small> <?php  echo $forecast['max_temp']; ?> °C </small></span>
              <span class="info-box-number">Min:  <small> <?php  echo $forecast['min_temp']; ?> °C</small></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        $condition =array 
                (
                  'where'=>array('condition_id' => $forecast['morning'],),
              ...
              ?>
        <!-- /.col -->
        <?php if(!empty($wheather)): $count = 0; foreach($wheather as $cond): $count++; ?>
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
             ...
             <span class="info-box-number"><em><?php echo  $cond['name'] ; ?></em></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
...
<?php
        ...
        $condition =array 
                (
                  'where'=>array('condition_id' => $forecast['afternoon'],),
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Afternoon</span>
             <span class="info-box-number"><em><?php echo  $cond['name'] ; ?></em></span>
            </div>
            <!-- /.info-box-content -->
          </div>
...
<?php
        ...
        $condition =array 
                (
                  'where'=>array('condition_id' => $forecast['evening'],),
...
<div class="col-sm-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Recent Alerts  </h3>
            </div>
            <!-- /.box-header -->
              ...
              ?>
                    ...
                    <tr><td colspan="8">No match found</td>
                         ...
                         <td>
                           ...
                           <a href="class/config.php?action_type=edit&id=<?php echo $new['ID']; ?>" class="fa fa-comment-o"> Reply</a>
