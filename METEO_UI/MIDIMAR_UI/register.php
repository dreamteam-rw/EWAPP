                ...
                <div class="box box-info">
                  ...
                  <select class="form-control">
                    ...
                    <option>option 5</option>
                          ...
                          <br>
                           <label>Select Concerned Regions or Sectors </label>
                 ...
                 <textarea class="textarea" placeholder="Enter Disaster Detail" name="detail_disaster" 
                    ...
                    <div class="box-footer clearfix">
                        ...
                        <button type="submit" name="userSubmit" class="btn btn-sm btn-info btn-flat pull-right">Submit</button>
                    </div>
                    <!-- /.box-footer -->
                  </div>
                 <!--RECENT REGISTER -->
