 ...
 <div class="col-sm-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Alert SMS List </h3>
            </div>
            <!-- /.box-header -->
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                     ...
                     <?php if(!empty($sms)): $ct = 0; foreach($sms as $msg): $ct++; ?>
                    <tr>
                        <td><?php echo '#'.$ct; ?></td>
                          <?php 
       $location="";
       $District="";
              ...
              ?>
                        ...
                        <td><?php echo  $msg['messagebody']; ?></td>
                    ...
                    <?php endforeach; else: ?>
                    <tr><td colspan="4">No match match</td>
